...
| **15** | MEI Tax Calculator            | Java 8+, Swing, File Handling, Tax Calculation    | Created a **MEI tax calculator**, which calculates the fixed tax (DAS) for individual microentrepreneurs and allows users to save tax reports. |
| **16** | Installment Simulator         | Java 8+, Swing, Interest Calculation, File Handling | Built an **installment payment simulator** that calculates monthly installment values based on interest rates and total payment, allowing users to save reports. |
| **17** | Loan Payment Simulator        | Java 8+, Swing, Interest Calculation, File Handling | Created a **loan payment simulator**, enabling users to calculate monthly payments based on interest rates and loan duration. |
| **18** | Unit Converter                | Java 8+, Swing, Unit Conversion, Event Handling   | Developed a **unit converter** that allows users to convert between kilometers/miles, Celsius/Fahrenheit, and kilograms/pounds. |
| **19** | Password Generator            | Java 8+, Swing, SecureRandom, Event Handling      | Built a **password generator** that creates strong passwords based on user-selected criteria, including length, numbers, uppercase, lowercase, and special characters. |
...
├── 📂 day17-loansimulator      # Loan Payment Simulator
